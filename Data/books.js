...
const books = [
  ...
  },
  {
    ...
    quotes: [  // ✅ Now it's an array
      ...
      "Comfort can be dangerous ,comfort provides both a floor and a ceiling.",
      "We spend so much time being afraid of failure,afraid of rejection.But regret is the thing we should fear most.Failure is an answer.Rejection is an answer.Regret is an eternal question you will never hava the answer to."
    ]
  },
  {
    id: 3,
